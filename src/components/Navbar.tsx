      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="font-bold text-lg leading-tight tracking-tight text-slate-900 flex items-center gap-2">
                Aplikasi Guru Wali
                <span className="hidden sm:inline-block text-[10px] font-bold bg-blue-50 text-blue-700 border border-blue-200 px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                  Sistem Informasi Pendampingan
                </span>
              </h1>
              <div className="flex items-center space-x-2 text-xs text-slate-500">
                <span>SMP Negeri Indonesia</span>
                ...
                <span className="inline-flex items-center gap-1 text-[11px] font-medium text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-200">
                  ...
                  <span>{isCloudSyncing ? 'Menyinkronkan...' : 'Cloud Sync Aktif (HP & Laptop)'}</span>
                </span>
              </div>
            </div>
          </div>
